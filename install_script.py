...
pathtools = env.addModule(
    'pathtools',
    tar='pathtools-0.1.2.tar.gz',
    url='http://pypi.python.org/packages/source/p/pathtools/pathtools-0.1.2.tar.gz',  # noqa
    targets=['pathtools-0.1.2*'],
    default=True)

watchdog = env.addModule(
    'watchdog',
    tar='watchdog-0.8.3.tar.gz',
    url='http://pypi.python.org/packages/source/w/watchdog/watchdog-0.8.3.tar.gz',  # noqa
    targets=['watchdog-0.8.3*'],
    default=True,
    deps=[pathtools])
